-- =============================================================================
-- Aislar los hooks de gamificación dentro de finalize_response para que
-- no rompan el feedback si algo en el XP / missions / achievements falla.
-- El error se loguea en processing_error_code para diagnóstico.
-- =============================================================================
...
begin
  -- ===== Original feedback logic (idéntico al baseline) =====
