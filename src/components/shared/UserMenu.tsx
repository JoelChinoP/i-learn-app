...
export function UserMenu({ name, email, settingsPath, profilePath, onSignOut }: UserMenuProps) {
  ...
  return <DropdownMenu>
    ...
    <DropdownMenuContent align="end" className="w-56">
      ...
      {profilePath && <><DropdownMenuSeparator /><DropdownMenuItem className="cursor-pointer" onClick={() => navigate(profilePath)}><UserRound className="size-4" />Mi perfil</DropdownMenuItem></>}
